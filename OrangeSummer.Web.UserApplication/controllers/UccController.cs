...
{
    public class UccController : ApiController
    {
        #region [ UCC 투표 ]
        /// <summary>
        /// UCC 투표
        ...
        public HttpResponseMessage Vote(VoteRequest request)
        {
            ...
            try
            {
                ...
                using (Business.Ucc biz = new Business.Ucc(Common.User.AppSetting.Connection))
                {
        ...
        public HttpResponseMessage Like(LikeRequest request)
        {
            ...
            try
            {
                ...
                using (Business.UccReply biz = new Business.UccReply(Common.User.AppSetting.Connection))
                {
                    Model.UccReplyLike like = biz.UserLike(request.Id, Common.User.Identify.Id);
        ...
        public HttpResponseMessage Regist(RegistRequest request)
        {
            ...
            try
            {
                ...
                using (Business.UccReply biz = new Business.UccReply(Common.User.AppSetting.Connection))
                {
                    bool result = biz.UserRegist(new Model.UccReply()
                    {
        ...
        public HttpResponseMessage Modify(ModifyRequest request)
        {
            ...
            try
            {
                ...
                using (Business.UccReply biz = new Business.UccReply(Common.User.AppSetting.Connection))
                {
                    bool result = biz.UserModify(new Model.UccReply()
                    {
                        Id = request.Id,
                        FkMember = Common.User.Identify.Id,
                        Contents = request.Contents.Replace("\n", Environment.NewLine)
        ...
        public HttpResponseMessage Answer(AnswerRequest request)
        {
            ...
            try
            {
                ...
                using (Business.UccReply biz = new Business.UccReply(Common.User.AppSetting.Connection))
                {
                    bool result = biz.UserAnswer(new Model.UccReply()
                    {
                        Id = request.Id,
                        FkMember = Common.User.Identify.Id,
                        Contents = request.Contents.Replace("\n", Environment.NewLine)
