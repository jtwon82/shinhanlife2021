<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="OrangeSummer.Web.UserApplication.board.notice.detail" %>
        ...
        <div id="wrap" class="wrapper">
            ...
            <div class="board_view_wrap">
                ...
                <div class="download">
                    ...
                    <asp:LinkButton ID="btnDownload" runat="server" OnClick="btnDownload_Click" CssClass="btn-file-down" Text="다운로드"></asp:LinkButton>
                    <%--<a href="#" class="btn-file-down">
                        다운로드
                    </a>--%>
                </div>
                <!-- //200629 수정 -->
