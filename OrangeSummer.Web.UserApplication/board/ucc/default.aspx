<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Web.UserApplication.board.ucc._default" %>

<%@ Register Src="~/common/uc/menu.ascx" TagPrefix="uc1" TagName="menu" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page_event01">
        <div id="wrap" class="wrapper">
            ...
            <div class="event_kv event_ucc">
                <img src="/resources/img/event_kv_UCC.png?v=20200714_1" alt="">

                <div class="ucc_box">
                    <ul class="ucc_list">
                        <li>
                            <div class="img">
                                <a href="javascript:;" data-video="https://www.youtube.com/embed/IBBLOVFj7tU">
                                    <img src="/resources/img/event_UCC_list1.png" alt="">
                                </a>
                            </div>
                            <label for="ucc_list01">SUPER사업단</label>
                            <input type="radio" name="ucc_list" id="ucc_list01" value="1" />
                        </li>
                        <li>
                            <div class="img">
                                <a href="javascript:;" data-video="https://www.youtube.com/embed/hgajQTnZJqQ">
                                    <img src="/resources/img/event_UCC_list2.png" alt="">
                                </a>
                            </div>
                            <label for="ucc_list02">금강지점</label>
                            <input type="radio" name="ucc_list" id="ucc_list02" value="2" />
                        </li>
                        <li>
                            <div class="img">
                                <a href="javascript:;" data-video="https://www.youtube.com/embed/CE8hN4kgKPY">
                                    <img src="/resources/img/event_UCC_list3.png" alt="">
                                </a>
                            </div>
                            <label for="ucc_list03">대치사업본부</label>
                            <input type="radio" name="ucc_list" id="ucc_list03" value="3" />
                        </li>
                        <li>
                            <div class="img">
                                <a href="javascript:;" data-video="https://www.youtube.com/embed/cXgXU7mcsP4">
                                    <img src="/resources/img/event_UCC_list4.png" alt="">
                                </a>
                            </div>
                            <label for="ucc_list04">반포지점</label>
                            <input type="radio" name="ucc_list" id="ucc_list04" value="4" />
                        </li>
                        <li>
                            <div class="img">
                                <a href="javascript:;" data-video="https://www.youtube.com/embed/Bbi2YdHSW3A">
                                    <img src="/resources/img/event_UCC_list5.png" alt="">
                                </a>
                            </div>
                            <label for="ucc_list05">선두지점</label>
                            <input type="radio" name="ucc_list" id="ucc_list05" value="5" />
                        </li>
                        <li>
                            <div class="img">
                                <a href="javascript:;" data-video="https://www.youtube.com/embed/Gc1UQH1PEkY">
                                    <img src="/resources/img/event_UCC_list6.png" alt="">
                                </a>
                            </div>
                            <label for="ucc_list06">신화창조지점</label>
                            <input type="radio" name="ucc_list" id="ucc_list06" value="6" />
                        </li>
                    </ul>

                    <a href="javascript:ucc.vote();" class="btn_ucc">
                        <img src="/resources/img/event_kv01_btn.png" alt="투표하기">
                    </a>
                </div>
            </div>
            ...
            <!-- popup -->
            <div class="popup_wrap popup_ucc">
                <div class="popup_inner">
                    ...
                    <button class="popup_close">
                        <img src="/resources/img/btn_close2.png" alt="닫기">
                    </button>
                </div>
            </div>
            <!-- //popup -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptPlaceHolder1" runat="server">
    <script>
        var ucc = {
            vote: function () {
                var literal = {
                    usr: { selector: $(":input:radio[name='ucc_list']"), required: { message: "투표할 UCC를 선택해주세요." } }
                };
