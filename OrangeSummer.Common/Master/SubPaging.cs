...
namespace OrangeSummer.Common.Master
{
    public class SubPaging
    {
        ...
        public SubPaging(string target, int page, int size, int block, int count)
        {
            _target = target;
            _page = page;
            _size = size;
        ...
        public override string ToString()
        {
            ...
            if (_total > 0)
            {
                ...
                sb.AppendFormat("      <a class=\"page-link\" href=\"{0}?subpage=1{1}\" tabindex=\"-1\">&lt;&lt;</a>", _target, param);
                sb.AppendFormat("    </li>");
                if (_start > _block)
                {
                    int pre = _start - _block;
                    sb.AppendFormat("    <li class=\"page-item\"><a class=\"page-link\" href=\"{0}?subpage={1}{2}\">&lt;</a></li>", _target, pre, param);
                }
                else
                ...
                for (int i = _start; i <= _end; i++)
                {
                    if (_page == i)
                        ...
                        sb.AppendFormat("    <li class=\"page-item\"><a class=\"page-link\" href=\"{0}?subpage={1}{2}\">{1}</a></li>", _target, i, param);
                }

                if (_total > _end)
                {
                    int next = _start + _block;
                    sb.AppendFormat("    <li class=\"page-item\"><a class=\"page-link\" href=\"{0}?subpage={1}{2}\">&gt;</a></li>", _target, next, param);
                }
                else
                    sb.AppendFormat("    <li class=\"page-item disabled\"><a class=\"page-link\" href=\"javascript:;\">&gt;</a></li>");
                ...
                sb.AppendFormat("      <a class=\"page-link\" href=\"{0}?subpage={1}{2}\">&gt;&gt;</a>", _target, _total, param);
                sb.AppendFormat("    </li>");
                sb.AppendFormat("  </ul>");
                sb.AppendFormat("</nav>");
            }
